...
const (
	...
	DISTANCE    = "200km"
	BUCKET_NAME = "uzumaki-image"
	// Needs to update this URL if you deploy it to cloud.
	ES_URL     = "http://34.73.73.31:9200"
	API_PREFIX = "/api/v1"
)
...
func handlerPost(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Println("Saved one post to Bigtable: %s", p.message)
	*/
}
...
func saveToBigTable(p *Post, id string) error {
	...
	bt_client, err := bigtable.NewClient(ctx, "around0225", "around-post")
	if err != nil {
		return err
	}
